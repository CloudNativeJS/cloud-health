...
describe('Health Checker test suite', () => {
    ...
    it('Startup reports STARTING when first is starting and second is up', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield healthcheck.registerReadinessCheck(check2);
        const status = yield healthcheck.getStatus();
    ...
    it('Startup reports STARTING when first is up and the second is starting', () => __awaiter(this, void 0, void 0, function* () {
        ...
        let check1 = new index_1.ReadinessCheck('Check1', Check1);
        yield healthcheck.registerReadinessCheck(check1);
        const Check2 = new Promise((resolve, _reject) => {
            setTimeout(() => {
                process.kill(process.pid, 'SIGTERM');
            }, 1000);
    ...
    it('Startup reports STARTING when multiple checks are still starting', () => __awaiter(this, void 0, void 0, function* () {
        ...
        let check1 = new index_1.ReadinessCheck("check", promise1);
        ...
        let check2 = new index_1.ReadinessCheck("check", promise2);
        healthcheck.registerReadinessCheck(check1);
        healthcheck.registerReadinessCheck(check2);
        const status = yield healthcheck.getStatus();
        const result = status.status;
    ...
    it('Health reports UP and empty checks array no registered checks', () => __awaiter(this, void 0, void 0, function* () {
        let healthcheck = new index_1.HealthChecker();
        const status = yield healthcheck.getStatus();
        const result = JSON.stringify(status);
    ...
    it('Health reports UP and check result with single registered check', () => __awaiter(this, void 0, void 0, function* () {
        let healthcheck = new index_1.HealthChecker();
        // tslint:disable-next-line:no-shadowed-variable
        const promise = () => new Promise((resolve, _reject) => {
            resolve();
    ...
    it('Health reports UP and check result with two registered checks', () => __awaiter(this, void 0, void 0, function* () {
        let healthcheck = new index_1.HealthChecker();
        // tslint:disable-next-line:no-shadowed-variable
    ...
    it('Health reports DOWN and check result with single failed check', () => __awaiter(this, void 0, void 0, function* () {
        let healthcheck = new index_1.HealthChecker();
        const promise = () => new Promise((_resolve, _reject) => {
            throw new Error("Startup Failure");
        });
    ...
    it('Health reports DOWN and check result with single rejected check', () => __awaiter(this, void 0, void 0, function* () {
        let healthcheck = new index_1.HealthChecker();
    ...
    it('Health reports UP with running PingCheck', () => __awaiter(this, void 0, void 0, function* () {
        let healthcheck = new index_1.HealthChecker();
    ...
    it('Health reports DOWN with failing PingCheck', () => __awaiter(this, void 0, void 0, function* () {
        let healthcheck = new index_1.HealthChecker();
    ...
    it('Health reports DOWN and check result with one passed and one failed registered checks', () => __awaiter(this, void 0, void 0, function* () {
        let healthcheck = new index_1.HealthChecker();
